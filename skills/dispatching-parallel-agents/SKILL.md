...
3. **Specific about output** - What should the task return?
...
2. **Focus** - Each task has narrow scope, less context to track
3. **Independence** - Tasks don't interfere with each other
...
4. **Spot check** - Tasks can make systematic errors
